...
(function() {
  ...
  ImagePickerOption = (function() {
    ...
    ImagePickerOption.prototype.mark_as_selected = function() {
      ...
      select_value = this.picker.select.val();
	   var select2 ;
	   select2 = this.picker.select.val();
	  // alert(select_value);
	
	  var nn =this.option.val();
		
       this.node.find(".thumbnail").addClass("selected");
	    this.node.find(".image_picker_image").addClass("selected"+nn);
		//var div = document.getElementsByTagName('div');
		
	  if( select2 == '1'){
		  //alert(123)
		    $(".selected1").attr('src','images/center/1.png'); 
		  }
		   else if(select2 == '2'){
			   //alert(select2)
			   $(".selected2").attr('src','images/center/2.png'); 
			  }
			  
			  else if(select2 == '3'){
			   $(".selected3").attr('src','images/center/3.png'); 
			  }
			  else if(select2 == '4'){
			   $(".selected4").attr('src','images/center/4.png'); 
			  }
			  else if(select2 == '5'){
			   $(".selected5").attr('src','images/center/5.png'); 
			  }
	 
		
	 
	  // return this.node.find(".image_picker_image").addClass("id"+'select_value');
	 // return this.node.find(".thumbnail img").addClass("css");
    };
    ...
    ImagePickerOption.prototype.unmark_as_selected = function() {
      ...
      select_value = this.picker.select.val();
	   ...
	   //alert(select_value);
	    var nn =this.option.val();
       this.node.find(".thumbnail").removeClass("selected");
	   this.node.find(".image_picker_image").removeClass("selected"+nn);
	     if( select2 == '1' ){
		     //$("img[id=1]").attr('src','images/1.png'); 
			 $("img[id=2]").attr('src','images/2.png'); 
			     $("img[id=3]").attr('src','images/3.png'); 
				  $("img[id=4]").attr('src','images/4.png');
				  
				   $("img[id=5]").attr('src','images/5.png'); 
		  }else if(select2 =='2'){
			  $("img[id=1]").attr('src','images/1.png'); 
			  // $("img[id=2]").attr('src','images/2.png'); 
			     $("img[id=3]").attr('src','images/3.png'); 
