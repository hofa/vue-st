...
(function(){
            ...
            try{
                ...
                if(_validator instanceof Array){
                    ...
                    for(var i=0;i<_validator.length;i++){
                        var tmpRet = _validator[i].valid(autoFocus);
                        if(!tmpRet)
                            return false;
                    }
                }else{
    ...
    $.validator.setError = function(target,autoFocus){
        ...
        $.validator.msg.show.call($.validator.msg,target);
        /*if(autoFocus){
            target.focus();
        }*/
    };
    ...
    $.validator.msg = {
        ...
        show : function(target){
            ...
            var _validator = dataTarget.data($.validator.setting.data_key);
            var rule = _validator.rules[_validator.currentRule];

            var msg = rule.msg[rule.validClass] || $.validator.messages[rule.validClass];
            var _msg = $.validator.format(msg,rule.params,_validator.name);
